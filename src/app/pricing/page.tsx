...
const Page = () => {
  ...
  return (
    <>
        <MaxWidthWrapper className="mb-8 mt-24 text-center max-width-5xl">
                  ...
                  {pricingItems.map(({plan,tagline,quota,features})=>{
                    ...
                    return (
                      <div key={plan} className={cn('relative rounded-2xl bg-white shadow-lg',{
                          ...
                          <div className="flex items-center space-x-1">
                            ...
                            <Tooltip delayDuration={300}>
                              ...
                              <TooltipContent className="w-80 p-2">
                                How many PDF's you can upload per moth.
                              </TooltipContent>
                            </Tooltip>
                          </div>
                        </div>
                          ...
                          {features.map(({text,footnote,negative})=>(
                            <li key={text} className="flex space-x-5">
                              <div className="flex-shrink-0">
                                {negative ? <Minus className="h-6 w-6 text-gray-300"/>
                                          :<Check className="h-6 w-6 text-blue-500"/>}
                              </div>
                              {footnote ? (<div className="flex items-center space-x-1">
                        ...
                        <div className="p-5">
                          { plan === "Free" ? ((<Link href={user? '/dashboard':'/sign-in'} 
